...
import {  BrowserRouter as Router,
  Routes, Route, Link, useMatch, useNavigate } from 'react-router-dom'
 ...
 */}        </div>
        ...
        <button type='reset' onClick={()=>{
          ...
          console.log('fields',content,author,info)}}>reset</button>
      </form>
    </div>
  )
...
const Anecdote = (anecdotes) =>{
  ...
  const anecdote = match 
    ?  anecdotes.anecdotes.find(a => a.id === Number(match.params.id))
    : null
  console.log(anecdotes);
  console.log(anecdotes.anecdotes.find(a => a.id === Number(match.params.id)))
